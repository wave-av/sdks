...
impl<'a> Collab<'a> {
    ...
    pub fn list_rooms(
        &self,
        params: &CollabListRoomsParams,
    ) -> Result<Page<models::CollabRoom>, Error> {
        ...
        self.http
            .request("GET", "/collab/rooms", &query, None::<&serde_json::Value>)
    }

    /// Create a collaboration room (operationId: createCollabRoom, POST /collab/rooms).
    pub fn create_room(
        &self,
        body: &models::CollabRoomCreate,
    ) -> Result<models::CollabRoom, Error> {
