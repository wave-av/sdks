...
Typed client for **WAVE Autopilot** through the WAVE gateway. Entitlement is enforced server-side — installing this package does not grant access.

```bash
npm i @wave-av/autopilot      # pulls @wave-av/core automatically
```
