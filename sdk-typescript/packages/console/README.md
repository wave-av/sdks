...
Typed client for **WAVE Console** through the WAVE gateway. Entitlement is enforced server-side — installing this package does not grant access.

```bash
npm i @wave-av/console      # pulls @wave-av/core automatically
```
